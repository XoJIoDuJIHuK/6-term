...
- Nginx
  ...
  - есть прямое и обратное проксирования (он сам не помнит, где какое), одно из них ближе к серверу, другое - к клиенту
...
- WebRTC (web real time communication) - набор технологий, предназначенный для потоковой передачи данных (видео, аудио, ...)
  ...
  - RTCP: измеряются метрики качества, передаваемого потока
