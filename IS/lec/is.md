...
Анализ полинома 320:  
420: Описать генератор ПСП заданной комбинацией цифр, нарисовать схему, определить начальное состояние ячеек, по тактам посмотреть, какой будет период  
Нужно соединить выход 4 и выход 2, поэтому только 1 сумматор  
