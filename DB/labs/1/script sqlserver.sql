...
CREATE TABLE COMMITS (
    ...
    CONSTRAINT FK_COMMITS_DEVELOPER FOREIGN KEY (DEVELOPER) REFERENCES STAFF(NODE)
);
go
...
CREATE TABLE TESTS (
    ...
    CONSTRAINT FK_TESTS_TESTER FOREIGN KEY (TESTER) REFERENCES STAFF(NODE),
...
select * from COMMITS;
delete commits;
insert COMMITS (DEVELOPER, COMMIT_DATE) VALUES ((select node from staff where name = 'dev1'), '2023-01-03');

select * from TESTS;
delete TESTS;

INSERT INTO TEST_DATA (GEO_DATA, JSON_DATA) VALUES (geometry::STGeomFromText('POINT (16.18297209393728 -56.35314392272713)', 0), '{"xd":"kek"}')
INSERT INTO TEST_DATA (GEO_DATA, JSON_DATA) VALUES (geometry::STGeomFromText('POINT (27.681650960796674 57.52086128669956)', 0), '{"someData":[1,2,3]}')
INSERT INTO TEST_DATA (GEO_DATA, JSON_DATA) VALUES (geometry::STGeomFromText('POINT (-108.73115555747012 36.205901662713146)', 0), '["mama","mia"]')